...
const Sidebar = styled('aside')`
  ...
  background: linear-gradient(#3f51b5, #7986cb);
  background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#3f51b5), to(#7986cb));
  /* Safari 5.1, Chrome 10+ */
  background: -webkit-linear-gradient(top, #3f51b5, #7986cb);
  /* Firefox 3.6+ */
